...
langOption.forEach((get,con)=> {
    // Loop through the languages object
    for (let countryCode in languages) {
        ...
        option.textContent = languages[countryCode];
    ...
    fromText.addEventListener('input',function(){
        ...
        fetch(transLINK).then(translate => translate.json()).then(data =>{transText.value = data.responseData.translatedText;
        })
    })
